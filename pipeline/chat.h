...
public:
    ...
    bool init(const std::string& model_path_, DevMode dev_mode = DevMode::CPU_MODE, int n_threads = 1, int max_seq_len = 2048, float top_p = -1.0f, int top_k = -1, float temperature = -1.0f, size_t gpu_layer = 0);
