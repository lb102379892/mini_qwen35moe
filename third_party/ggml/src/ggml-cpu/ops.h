...
void ggml_compute_forward_ssm_conv_step(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_deltanet_decode_proj(const struct ggml_compute_params * params, struct ggml_tensor * dst);
